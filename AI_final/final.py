...
#データ読み取り
data = pd.read_csv('C:\\Users\\Owner\\Desktop\\AI_final\\wrime-ver1.tsv',encoding='UTF-8', sep='\t')
f = open('C:\\Users\\Owner\\Desktop\\AI_final\\getText.txt', encoding='UTF-8')
save_file = open('C:\\Users\\Owner\\Desktop\\AI_final\\result.txt', encoding='UTF-8', mode='w')
